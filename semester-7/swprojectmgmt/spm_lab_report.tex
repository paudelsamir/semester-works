...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{lab_images/0_project_dialog.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.85\textwidth]{lab_images/2_overall_gantt_chart.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{lab_images/3_WBS.png}
\caption{Work Breakdown Structure - Student Profile Management System}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{lab_images/4_rbs.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.85\textwidth]{lab_images/5_pert_cpm_diagram.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{lab_images/6_pert_nw_diagram.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{lab_images/7_AOA_nw_diagram.png}
